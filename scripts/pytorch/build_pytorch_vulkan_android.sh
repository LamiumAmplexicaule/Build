...
MAX_JOBS=$JOBS PYTHONPATH=$(pwd) ANDROID_HOME=${ANDROID_HOME:?} ANDROID_NDK=${ANDROID_NDK:?} BUILD_LITE_INTERPRETER=0 USE_VULKAN=1 bash ./scripts/build_pytorch_android.sh $ANDROID_ABI
